...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    from .const import DOMAIN, SERVICE_PAIR_INVERTER, SERVICE_REBOOT_INVERTER, SERVICE_REPOLL
    from .coordinator import APSDataUpdateCoordinator
    ...
    if not hass.data.get(DOMAIN):
        for service in (SERVICE_PAIR_INVERTER, SERVICE_REPOLL, SERVICE_REBOOT_INVERTER):
